window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		/*
		 * VERSION CONTRACT — dsh 0.1.5-rc.2 (client-ui / web-frontend 0.1.5-rc.2)
		 *
		 ...
		 *      stable rc.6 → 0.1.5-rc.2 by dist scan; the two that drifted are
		 *      handled with dual-generation selectors below.
		 *
		 * Verified stable prefixes against client-ui 0.1.5-rc.2 dist
		 * (package attribution confirmed by scanning the installed tree):
		 *   layout               pI_x6G_
		 *   conversation         wSkVaW_ uV2eYG_ Sh0Q9G_ JObwrW_ pXSMma_ T1PP_q_
		 ...
		 */
		const css = `
/* ===== dsh-mobile: 手机端适配 (v22 — dsh 0.1.5-rc.2) ===== */
